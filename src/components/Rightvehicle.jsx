      ...
      <div className="rightvehicle">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 right-content" data-aos="zoom-in-down">
              <h1>Choosing the Right Vehicle</h1>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Hi88Limo offers affordable van rentals in Chicago for various occasions, including passenger vans and minivans. Our Sprinter van rentals are a good option for both business and leisure trips
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
